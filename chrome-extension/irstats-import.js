(function () {
  ...
  var BATCH_SIZE = 15;
  // Version 2 adds the ROAD wallet. Run one deliberate complete gap audit after this upgrade so
  // races that the old parser rejected in 2023/24 are found; future runs go back to page-zero-only.
  var ROAD_RECONCILIATION = window.localStorage.getItem("iis_import_schema") !== "2";
  var FULL_SCAN = window.localStorage.getItem("iis_full_scan") === "true" || ROAD_RECONCILIATION;
