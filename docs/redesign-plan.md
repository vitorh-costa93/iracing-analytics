...
- [x] Etapa 1 (25/09/2026: tokens `--ng-`, fontes, cabeçalho global, `components/ui/`, `/debriefs` placeholder) · [ ] 2 · [ ] 3 · [ ] 4 · [x] 5 (26/09/2026: página /debriefs com season e week, modal removido) · [x] 6 (26/09/2026: Setup Lab com chat persistente, proposta A/B estruturada e comparador em linguagem de piloto) · [ ] 7 · [ ] Publicação em produção
