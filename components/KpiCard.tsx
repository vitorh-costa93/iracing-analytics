type Props = { eyebrow: string; value: number | null; previousValue: number | null; previousLabel: string; mode?: "irating" | "wins"; displayValue?: string | null; safetyRatingDisplay?: string | null };
...
export default function KpiCard({ eyebrow, value, previousValue, previousLabel, mode = "irating", displayValue, safetyRatingDisplay }: Props) {
